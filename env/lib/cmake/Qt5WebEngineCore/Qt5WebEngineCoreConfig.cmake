...
set(Qt5WebEngineCore_VERSION_STRING 5.15.9)
...
if (NOT TARGET Qt5::WebEngineCore)
    ...
    set(Qt5WebEngineCore_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngineCore_install_prefix}/include/qt/QtWebEngineCore/5.15.9"
        "${_qt5WebEngineCore_install_prefix}/include/qt/QtWebEngineCore/5.15.9/QtWebEngineCore"
    )
    ...
    foreach(_module_dep ${_Qt5WebEngineCore_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.9 ${_Qt5WebEngineCore_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::WebEngineCore PROPERTY INTERFACE_QT_DISABLED_FEATURES webengine-extensions;webengine-native-spellchecker)

    # Qt 6 forward compatible properties.
    set_property(TARGET Qt5::WebEngineCore
                 PROPERTY QT_ENABLED_PUBLIC_FEATURES
                 webengine-geolocation;webengine-spellchecker;webengine-webchannel)
    set_property(TARGET Qt5::WebEngineCore
                 PROPERTY QT_DISABLED_PUBLIC_FEATURES
                 webengine-extensions;webengine-native-spellchecker)
    set_property(TARGET Qt5::WebEngineCore
                 PROPERTY QT_ENABLED_PRIVATE_FEATURES
                 webengine-embedded-build;webengine-v8-snapshot-support)
    set_property(TARGET Qt5::WebEngineCore
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 webengine-alsa;webengine-printing-and-pdf;webengine-kerberos;webengine-ozone;webengine-pepper-plugins;webengine-poppler-cpp;webengine-proprietary-codecs;webengine-pulseaudio;webengine-webrtc;webengine-webrtc-pipewire)
    ...
    _populate_WebEngineCore_target_properties(RELEASE "libQt5WebEngineCore.5.15.9.dylib" "" FALSE)
