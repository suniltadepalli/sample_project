...
set(Qt5Pdf_VERSION_STRING 5.15.9)
...
macro(_populate_Pdf_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5Pdf_install_prefix}/lib/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Pdf)
    ...
    set(Qt5Pdf_PRIVATE_INCLUDE_DIRS
        "${_qt5Pdf_install_prefix}/include/qt/QtPdf/5.15.9"
        "${_qt5Pdf_install_prefix}/include/qt/QtPdf/5.15.9/QtPdf"
    )
    ...
    foreach(_module_dep ${_Qt5Pdf_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.9 ${_Qt5Pdf_FIND_VERSION_EXACT}
    ...
    _populate_Pdf_target_properties(RELEASE "libQt5Pdf.5.15.9.dylib" "" FALSE)
